        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item" href="http://localhost:9999/onlineshopping/managerStoreProduct"><i class='app-menu__icon bx bx-run'></i><span
                            class="app-menu__label">Quản lý hàng trong kho
                        </span></a></li><!--
        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb side">
                    <li class="breadcrumb-item active"><a href="#"><b>View History Send</b></a></li>
                </ul>
                <div id="clock"></div>
            </div>
            <div class="row">
                                ...
                                <tbody>
                                    <c:forEach items="${listIm}" var="o" varStatus="loop">
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary btn-sm trash" type="button" title="Xóa" onclick="deleteItem(${o.import_id})">
