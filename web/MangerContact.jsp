                    ...
                    <div class="page-breadcrumb">
                        <div class="row align-items-center">
                            <div class="col-md-6 col-8 align-self-center">
                                <h3 class="page-title mb-0 p-0">Manager Contact</h3>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Manager Contact</h4>
                                        <div class="table-responsive">
                                            <table class="table user-table">
                                                <thead>
                                                    <tr>
                                                        <th class="border-top-0">ContactID</th>
                                                        <th class="border-top-0">Customer Name</th>
                                                        <th class="border-top-0">Email</th>
                                                        <th class="border-top-0">Message</th>
                                                        <th class="border-top-0">AccountID</th>
                                                ...
                                                <c:forEach items="${listc}" var="o">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>${o.account_id}</td>
                                                            <td>
                                                                    <a class="btn btn-success d-none d-md-inline-block text-white" href="#">Reply</a>
                                                                </td>                                                   
