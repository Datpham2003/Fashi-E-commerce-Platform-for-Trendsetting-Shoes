        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    <li class="breadcrumb-item">Add new Provider</li>
<!--                    <li class="breadcrumb-item"><a href="#">Add new Provider</a></li>-->
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        <h3 class="tile-title">Add new Provider</h3>
                        <div class="tile-body">
                            ...
                            <form action="addProvider" method="POST">
                                <div class="form-group col-md-6">
                                    <label class="control-label">Name Provider</label>
                                    <input name="provider_name" class="form-control" type="text">
                                </div>

                                <div class="form-group  col-md-6">
                                    <label class="control-label">Address</label>
                                    <input name="provider_address" class="form-control" type="text">
                                </div>
                                
                                 <div class="form-group  col-md-6">
                                    <label class="control-label">Email</label>
                                    <input name="provider_email" class="form-control" type="text">
                                </div>
                                ...
                                <a class="btn btn-cancel" href="/onlineshopping/addImport">Cancle</a>
                            </form>
                        </div>
                    </div><!-- comment -->
                </div>
